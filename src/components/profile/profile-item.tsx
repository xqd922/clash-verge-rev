...
export const ProfileItem = (props: Props) => {
  ...
  const profileFileDocument = useEditorDocument({
    open: fileOpen,
    load: loadProfileFileDocument,
  })
    ...
    >
      ...
      {fileOpen && (
        <EditorViewer
          ...
          value={profileFileDocument.value}
          language="yaml"
          path={`profile:${uid}.yaml`}
          loading={profileFileDocument.loading}
          dirty={profileFileDocument.dirty}
          onChange={profileFileDocument.setValue}
      ...
      {mergeOpen && (
        <EditorViewer
          ...
          language="yaml"
          path={`profile:merge:${option?.merge ?? ''}.yaml`}
      ...
      {scriptOpen && (
        <EditorViewer
          ...
          language="javascript"
          path={`profile:script:${option?.script ?? ''}.js`}
