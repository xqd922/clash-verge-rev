...
`mihomo:allow-flush-smart-cache`

</td>
<td>

Enables the flush_smart_cache command without any pre-configured scope.
...
`mihomo:deny-flush-smart-cache`

</td>
<td>

Denies the flush_smart_cache command without any pre-configured scope.
...
`mihomo:allow-get-smart-weights`

</td>
<td>

Enables the get_smart_weights command without any pre-configured scope.
...
`mihomo:deny-get-smart-weights`

</td>
<td>

Denies the get_smart_weights command without any pre-configured scope.
