...
const WEBVIEW2_VERSION = "109.0.1518.78";
...
async function resolvePortable() {
  ...
  const webview2Dir = `Microsoft.WebView2.FixedVersionRuntime.${WEBVIEW2_VERSION}.${arch}`;
  ...
  zip.addLocalFolder(path.join(releaseDir, webview2Dir), webview2Dir);
  ...
  const zipFile = `${ZIP_PREFIX}_${version}_${arch}_fixed_webview2_portable.zip`;
