...
async function resolvePortable() {
  ...
  zip.addLocalFile(path.join(releaseDir, "Clash Verge Legacy.exe"));
  ...
  const zipFile = `Clash.Verge.Legacy_${version}_${arch}_fixed_webview2_portable.zip`;
  ...
  console.log("[INFO]: upload to ", releaseId ? `release ${releaseId}` : tag);
  ...
  let assets = releaseAssets.filter((x) => {
